...
if(isset($_POST['A1']) && isset($_POST['A2']) && isset($_POST['A3']) && isset($_POST['A4']) && isset($_POST['A5']) && isset($_POST['A6']) && isset($_POST['A7']) && isset($_POST['A8']) && isset($_POST['A9']) && isset($_POST['A10']) && isset($_POST['A11']) && isset($_POST['A12']) && isset($_POST['A13']) && isset($_POST['A14']) && isset($_POST['A15']) && isset($_POST['A16'])){
   ...
   try{
         ...
         $pdo->exec("INSERT INTO sites_mdf1 (periodo, df, MDF1_1, MDF1_1o, MDF1_2, MDF1_2o, MDF1_3, MDF1_3o, MDF1_4, MDF1_4o, MDF1_5, MDF1_5o, MDF1_6, MDF1_6o, MDF1_7, MDF1_7o, MDF1_8, MDF1_8o, MDF1_9, MDF1_9o, MDF1_10, MDF1_10o, MDF1_11, MDF1_11o, MDF1_12, MDF1_12o, MDF1_13, MDF1_13o, MDF1_14, MDF1_14o, MDF1_15, MDF1_15o, MDF1_16, MDF1_16o) VALUES (".$_POST['periodo'].",".$_POST['df'].",".$_POST['A1'].",'".$_POST['O1']."',".$_POST['A2'].",'".$_POST['O2']."',".$_POST['A3'].",'".$_POST['O3']."',".$_POST['A4'].",'".$_POST['O4']."',".$_POST['A5'].",'".$_POST['O5']."',".$_POST['A6'].",'".$_POST['O6']."',".$_POST['A7'].",'".$_POST['O7']."',".$_POST['A8'].",'".$_POST['O8']."',".$_POST['A9'].",'".$_POST['O9']."',".$_POST['A10'].",'".$_POST['O10']."',".$_POST['A11'].",'".$_POST['O11']."',".$_POST['A12'].",'".$_POST['O12']."',".$_POST['A13'].",'".$_POST['O13']."',".$_POST['A14'].",'".$_POST['O14']."',".$_POST['A15'].",'".$_POST['O15']."',".$_POST['A16'].",'".$_POST['O16']."' ) ");
         $pdo->commit();
         header('location: sites-mdf2.php?p='.$_POST['periodo'].'&df='.$_POST['df']);
                  ...
                  <div class="row mb-2">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           ...
                           <li class="breadcrumb-item active">MDF 1. MEMORIA TÉCNICA</li>
                        </ol>
                     </div>
                     <!-- /.col -->
                  </div>
                        ...
                        <div class="info-box elevation-2">
                           ...
                           <table class="table table-sm table-hover form-group">
                              ...
                              <tbody>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>1.10</td>
                                    <td>EN ORDEN EL CABLEADO FRONTAL AL RACK (NODOS Y PACHD CORD)</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>1.11</td>
                                    <td>EN ORDEN EL CABLEADO POSTERIOR AL RACK (NODOS Y PACHD CORD)</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>1.13</td>
                                    <td>ESTAN ORDENADOS LOS EQUIPOS EN EL MDF</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>1.14</td>
                                    <td>SE CUENTA CON BITACORA DE MANTENIMIENTO DE LOS EQUIPOS</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>1.16</td>
                                    <td>LAS IPS ASIGNADAS A LOS EQUIPOS SON LAS CORRECTAS.</td>
