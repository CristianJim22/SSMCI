...
if(isset($_POST['C1']) && isset($_POST['C2']) && isset($_POST['C3']) && isset($_POST['C4']) && isset($_POST['C5']) && isset($_POST['C6']) && isset($_POST['C7']) && isset($_POST['C8']) && isset($_POST['C9']) ){
   ...
   try{
         ...
         $pdo->exec("INSERT INTO sites_mdf3 (periodo, df, MDF3_1, MDF3_1o, MDF3_2, MDF3_2o, MDF3_3, MDF3_3o, MDF3_4, MDF3_4o, MDF3_5, MDF3_5o, MDF3_6, MDF3_6o, MDF3_7, MDF3_7o, MDF3_8, MDF3_8o, MDF3_9, MDF3_9o) VALUES (".$_POST['periodo'].",".$_POST['df'].",".$_POST['C1'].",'".$_POST['O1']."',".$_POST['C2'].",'".$_POST['O2']."',".$_POST['C3'].",'".$_POST['O3']."',".$_POST['C4'].",'".$_POST['O4']."',".$_POST['C5'].",'".$_POST['O5']."',".$_POST['C6'].",'".$_POST['O6']."',".$_POST['C7'].",'".$_POST['O7']."',".$_POST['C8'].",'".$_POST['O8']."',".$_POST['C9'].",'".$_POST['O9']."' ) ");
         $pdo->commit();
                  ...
                  <div class="row mb-2">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           ...
                           <li class="breadcrumb-item active">MDF 3. APOYOS OBTENIDOS DE LA UNIDAD</li>
                        </ol>
                     </div>
                     <!-- /.col -->
                  </div>
                        ...
                        <div class="info-box elevation-2">
                           ...
                           <table class="table table-sm table-hover form-group">
                              ...
                              <tbody>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>3.2</td>
                                    <td>EL MDF ESTA INCLUIDA EN EL PROGRAMA DE LIMPIEZA DE LA UNIDAD</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>3.3</td>
                                    <td>EL AREA ES EXCLUSIVA PARA EL MDF</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>3.7</td>
                                    <td>LA CLIMATIZACIÓN ES ACEPTABLE (< 23 GRADOS)</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>3.9</td>
                                    <td>ESTA EL CENTRO DE DATOS EN EL PLAN DE CONTINGENCIA DE LA UNIDAD</td>
