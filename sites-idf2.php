...
if(isset($_POST['B1']) && isset($_POST['B2']) && isset($_POST['B3']) && isset($_POST['B4']) && isset($_POST['B5']) && isset($_POST['B6']) && isset($_POST['B7']) && isset($_POST['B8']) && isset($_POST['B9']) && isset($_POST['B10']) && isset($_POST['B11']) && isset($_POST['B12']) ){
   $db = new Databaseocs();
   try{
         $pdo = $db->connect();
         $pdo->beginTransaction();
         $pdo->exec("INSERT INTO sites_idf2 (periodo, df, IDF2_1, IDF2_1o, IDF2_2, IDF2_2o, IDF2_3, IDF2_3o, IDF2_4, IDF2_4o, IDF2_5, IDF2_5o, IDF2_6, IDF2_6o, IDF2_7, IDF2_7o, IDF2_8, IDF2_8o, IDF2_9, IDF2_9o, IDF2_10, IDF2_10o, IDF2_11, IDF2_11o, IDF2_12, IDF2_12o) VALUES (".$_POST['periodo'].",".$_POST['df'].",".$_POST['B1'].",'".$_POST['O1']."',".$_POST['B2'].",'".$_POST['O2']."',".$_POST['B3'].",'".$_POST['O3']."',".$_POST['B4'].",'".$_POST['O4']."',".$_POST['B5'].",'".$_POST['O5']."',".$_POST['B6'].",'".$_POST['O6']."',".$_POST['B7'].",'".$_POST['O7']."',".$_POST['B8'].",'".$_POST['O8']."',".$_POST['B9'].",'".$_POST['O9']."',".$_POST['B10'].",'".$_POST['O10']."',".$_POST['B11'].",'".$_POST['O11']."',".$_POST['B12'].",'".$_POST['O12']."' ) ");
         $pdo->commit();
         header('location: sites-idf3.php?p='.$_POST['periodo'].'&df='.$_POST['df']);
                  ...
                  <div class="row mb-2">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           ...
                           <li class="breadcrumb-item active">IDF 2. APLICACIÓN DE CONTROLES DE SEGURIDAD</li>
                        </ol>
                     </div>
                     <!-- /.col -->
                  </div>
                           ...
                           <table class="table table-sm table-hover form-group">
                              ...
                              <tbody>
                                 <tr class="font-weight-normal">
                                    <td>2.1</td>
                                    <td>TIENE UNA BITÁCORA QUE REGISTRE EL ACCESO AL IDF</td>
                                 ...
                                 <tr class="font-weight-normal">
                                    <td>2.10</td>
                                    <td>EL IDF ESTA UBICADO EN UN AREA CORRECTA</td>
